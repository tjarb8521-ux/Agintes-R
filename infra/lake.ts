...
const tableBucketName = `agintes-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `agintes-${$app.stage}-lake-ingest`,
    destination: "iceberg",
