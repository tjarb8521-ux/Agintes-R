...
Generates UPCOMING_CHANGELOG.md by running the agintes changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for agintes run (default: low)
      --quiet            Suppress agintes command output unless it fails
