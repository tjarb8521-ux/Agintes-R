...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/agintes/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/agintes...\n")
...
console.log("Fetching npm all-time downloads for agintes-ai...\n")
const npmDownloads = await fetchNpmDownloads("agintes-ai")
