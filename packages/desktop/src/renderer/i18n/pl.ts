export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Agintes",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Agintes. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'agintes'.",
