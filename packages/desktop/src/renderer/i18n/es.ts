export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Agintes",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Agintes. ¿Quieres instalarla y reiniciar?",
