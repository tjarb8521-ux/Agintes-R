...
import type { FileSearchHandle } from "@agintes-ai/session-ui/file"
import { useFileComponent } from "@agintes-ai/ui/context/file"
import { cloneSelectedLineRange, previewSelectedLines } from "@agintes-ai/session-ui/pierre/selection-bridge"
import { createLineCommentController } from "@agintes-ai/session-ui/line-comment-annotations"
import { createLineCommentControllerV2 } from "@agintes-ai/session-ui/v2/line-comment-annotations-v2"
import { sampledChecksum } from "@agintes-ai/core/util/encode"
import { normalize, text } from "@agintes-ai/session-ui/session-diff"
import { DropdownMenu } from "@agintes-ai/ui/dropdown-menu"
import { IconButton } from "@agintes-ai/ui/icon-button"
import { LineCommentV2OverflowIcon } from "@agintes-ai/ui/v2/line-comment-v2"
import { MenuV2 } from "@agintes-ai/ui/v2/menu-v2"
import { Tabs } from "@agintes-ai/ui/tabs"
import { ScrollView } from "@agintes-ai/ui/scroll-view"
  ...
  const renderFile = (source: string) => (
    <div class="relative overflow-hidden pb-40">
      <Dynamic
        ...
        search={search}
        class="select-text [--agintes-diffs-bg:var(--v2-background-bg-base)]"
        media={{
          mode: "auto",
          path: path(),
