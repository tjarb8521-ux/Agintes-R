...
import { Session } from "@agintes-ai/sdk/v2/client"
...
import { toaster } from "@agintes-ai/ui/toast"
...
import { retry } from "@agintes-ai/core/util/retry"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://agintes.ai/desktop-feedback")}
      renderPanel={() =>
