...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "agintes", key: "dialog.provider.agintes.note" },
  { match: (id: string) => id === "agintes-go", key: "dialog.provider.agintesGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "agintes" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "agintes" || item.id === "agintes-go"}>
