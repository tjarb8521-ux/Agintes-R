...
beforeAll(async () => {
  ...
  mock.module("@agintes-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@agintes-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@agintes-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@agintes-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
