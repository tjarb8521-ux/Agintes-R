import type { AgintesEvent, SessionMessageInfo, SessionPendingMessage } from "@agintes-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: AgintesEvent): V2SessionReduction | undefined => {
