import type { AgintesEvent } from "@agintes-ai/client/promise"
import type { Event } from "@agintes-ai/sdk/v2/client"
...
export type ServerEvent = Event & { current?: AgintesEvent }
...
export function adaptServerEvent(event: AgintesEvent): ServerEvent {
...
function currentDelta(event: AgintesEvent | undefined): CurrentDelta | undefined {
  if (
