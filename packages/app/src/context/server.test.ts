  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://agintes.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://agintes.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://agintes.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://agintes.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://agintes.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://agintes.example.com"),
      ),
    ).toEqual({
