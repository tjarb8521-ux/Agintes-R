...
import type { Config, OpencodeClient, Project } from "@agintes-ai/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ProjectApi, ReferenceApi } from "@agintes-ai/client/promise"
import type { NormalizedProviderListResponse } from "@agintes-ai/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
