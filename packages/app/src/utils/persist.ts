...
const GLOBAL_STORAGE = "agintes.global.dat"
const WINDOW_STORAGE = "agintes.window"
const LOCAL_PREFIX = "agintes."
...
function workspaceStorage(dir: string) {
  ...
  return `agintes.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `agintes.draft.${head}.${sum}.dat`
}
