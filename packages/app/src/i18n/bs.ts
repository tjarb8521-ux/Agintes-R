export const dict = {
  ...
  "dialog.provider.agintes.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.agintes.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.agintesGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Agintes",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Agintes-u.",
  ...
  "provider.connect.agintesZen.line1":
    "Agintes Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.agintesZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.agintesZen.visit.prefix": "Posjeti ",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Agintes-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Agintes-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u agintes.json",
  ...
  "dialog.server.description": "Promijeni na koji se Agintes server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Agintes...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Agintes u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Agintes...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Agintes u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Agintes u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Agintes",
  "wsl.onboarding.agintesReadyIn": "Agintes je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.agintesReady": "Agintes je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Agintes u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Agintes",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintes nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Agintes mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Agintes nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Agintes.",
  ...
  "toast.update.description": "Nova verzija Agintes-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Agintes timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (agintes.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Agintes još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Agintes uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Agintes server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Agintes-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Agintes izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Agintes prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Agintes-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Agintes pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Agintes-a.",
