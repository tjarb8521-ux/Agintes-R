export const dict = {
  ...
  "dialog.provider.agintes.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.agintes.tagline": "Reliable optimized models",
  "dialog.provider.agintesGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Agintes",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Agintes.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.agintesZen.line1":
    "Agintes Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.agintesZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.agintesZen.visit.prefix": "Visit ",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Agintes.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Agintes.",
  ...
  "dialog.plugins.empty": "Plugins configured in agintes.json",
  ...
  "dialog.server.description": "Switch which Agintes server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Agintes...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Agintes in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Agintes...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Agintes in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Agintes in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Agintes",
  "wsl.onboarding.agintesReadyIn": "Agintes is ready in {{distro}}.",
  "wsl.onboarding.agintesReady": "Agintes is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Agintes in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Agintes",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintes not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Agintes can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Agintes could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Agintes.",
  ...
  "toast.update.description": "A new version of Agintes ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Agintes team",
  ...
  "error.chain.checkConfig": "Check your config (agintes.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Agintes does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Agintes includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Agintes server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Agintes",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Agintes looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Agintes follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Agintes is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Agintes launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Agintes.",
