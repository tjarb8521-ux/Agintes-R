export const dict = {
  ...
  "dialog.provider.agintes.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.agintes.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.agintesGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Agintes",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Agintes.",
  ...
  "provider.connect.agintesZen.line1":
    "يمنحك Agintes Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.agintesZen.visit.prefix": "قم بزيارة ",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Agintes.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Agintes.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في agintes.json",
  ...
  "dialog.server.description": "تبديل خادم Agintes الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Agintes...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Agintes في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Agintes...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Agintes في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Agintes في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Agintes",
  "wsl.onboarding.agintesReadyIn": "Agintes جاهز في {{distro}}.",
  "wsl.onboarding.agintesReady": "Agintes جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Agintes في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Agintes",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintes غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Agintes من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Agintes التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Agintes.",
  ...
  "toast.update.description": "نسخة جديدة من Agintes ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Agintes",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (agintes.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Agintes لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Agintes نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Agintes داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Agintes",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Agintes على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Agintes يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Agintes.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Agintes",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Agintes.",
