export const dict = {
  ...
  "dialog.provider.agintes.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.agintes.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.agintesGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Agintes",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Agintes.",
  ...
  "provider.connect.agintesZen.line1":
    "Agintes Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.agintesZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.agintesZen.visit.prefix": "Visite ",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Agintes.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Agintes.",
  ...
  "dialog.plugins.empty": "Plugins configurados em agintes.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Agintes este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Agintes...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Agintes em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Agintes...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Agintes em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Agintes em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Agintes",
  "wsl.onboarding.agintesReadyIn": "O Agintes está pronto em {{distro}}.",
  "wsl.onboarding.agintesReady": "O Agintes está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Agintes em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Agintes",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintes não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Agintes possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Agintes não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Agintes novamente.",
  ...
  "toast.update.description": "Uma nova versão do Agintes ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Agintes",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (agintes.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Agintes ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Agintes inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Agintes dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Agintes",
  ...
  "settings.general.row.appearance.description": "Personalize como o Agintes aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Agintes segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Agintes é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Agintes iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Agintes.",
