...
export const dict = {
  ...
  "dialog.provider.agintes.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.agintes.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.agintesGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Agintes",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Agintes zu nutzen.",
  ...
  "provider.connect.agintesZen.line1":
    "Agintes Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.agintesZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.agintesZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Agintes zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Agintes zu nutzen.",
  ...
  "dialog.plugins.empty": "In agintes.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Agintes-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.agintes": "Agintes",
  ...
  "wsl.onboarding.checkingOpencode": "Agintes wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Agintes in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Agintes wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Agintes in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Agintes in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Agintes aktualisieren",
  "wsl.onboarding.agintesReadyIn": "Agintes ist in {{distro}} bereit.",
  "wsl.onboarding.agintesReady": "Agintes ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Agintes in {{distro}}.",
  "wsl.onboarding.installOpencode": "Agintes installieren",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintes nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Agintes einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Agintes konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Agintes erneut.",
  ...
  "toast.update.description": "Eine neue Version von Agintes ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Agintes-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (agintes.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Agintes unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Agintes enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Agintes Desktop",
  ...
  "settings.desktop.wsl.description": "Agintes-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Agintes ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Agintes auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Agintes dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Agintes anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Agintes automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Agintes.",
