export const dict = {
  ...
  "dialog.provider.agintes.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.agintes.tagline": "Modèles optimisés et fiables",
  "dialog.provider.agintesGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Agintes",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Agintes.",
  ...
  "provider.connect.agintesZen.line1":
    "Agintes Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.agintesZen.visit.prefix": "Visitez ",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Agintes.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Agintes.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans agintes.json",
  ...
  "dialog.server.description": "Changez le serveur Agintes auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Agintes...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Agintes dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Agintes...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Agintes dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Agintes dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Agintes",
  "wsl.onboarding.agintesReadyIn": "Agintes est prêt dans {{distro}}.",
  "wsl.onboarding.agintesReady": "Agintes est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Agintes dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Agintes",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintes non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Agintes puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Agintes n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Agintes.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Agintes ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Agintes",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (agintes.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Agintes ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Agintes inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Agintes dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Agintes",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Agintes sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Agintes suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Agintes.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Agintes",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Agintes.",
