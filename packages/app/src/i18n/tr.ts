...
export const dict = {
  ...
  "dialog.provider.agintes.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.agintes.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.agintesGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Agintes tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Agintes'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.agintesZen.line1":
    "Agintes Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.agintesZen.visit.prefix": "",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Agintes'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Agintes'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler agintes.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Agintes sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Agintes kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Agintes kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Agintes güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Agintes güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Agintes'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Agintes'u güncelle",
  "wsl.onboarding.agintesReadyIn": "{{distro}} içinde Agintes hazır.",
  "wsl.onboarding.agintesReady": "Agintes hazır.",
  "wsl.onboarding.installOpencodeIn": "Agintes'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Agintes'u kur",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintes kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Agintes'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Agintes bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Agintes'u tekrar açın.",
  ...
  "toast.update.description": "Agintes'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Agintes ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (agintes.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Agintes henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Agintes ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Agintes Masaüstü",
  ...
  "settings.desktop.wsl.description": "Agintes sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Agintes'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Agintes'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Agintes'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Agintes'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Agintes başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Agintes'un en son sürümünü kullanıyorsunuz.",
