...
export const dict = {
  ...
  "dialog.provider.agintes.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.agintes.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.agintesGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Agintes",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Agintes.",
  ...
  "provider.connect.agintesZen.line1":
    "Agintes Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.agintesZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.agintesZen.visit.prefix": "Besøk ",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Agintes.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Agintes.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i agintes.json",
  ...
  "dialog.server.description": "Bytt hvilken Agintes-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Agintes ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Agintes-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (agintes.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Agintes ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Agintes inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Agintes-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Agintes",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Agintes ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Agintes skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Agintes er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Agintes starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Agintes.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Agintes...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Agintes i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Agintes...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Agintes i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Agintes i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Agintes",
  "wsl.onboarding.agintesReadyIn": "Agintes er klar i {{distro}}.",
  "wsl.onboarding.agintesReady": "Agintes er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Agintes i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintes er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Agintes kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Agintes kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Agintes på nytt.",
