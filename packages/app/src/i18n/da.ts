export const dict = {
  ...
  "dialog.provider.agintes.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.agintes.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.agintesGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Agintes",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Agintes.",
  ...
  "provider.connect.agintesZen.line1":
    "Agintes Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.agintesZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.agintesZen.visit.prefix": "Besøg ",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Agintes.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Agintes.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i agintes.json",
  ...
  "dialog.server.description": "Skift hvilken Agintes-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Agintes...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Agintes i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Agintes...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Agintes i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Agintes i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Agintes",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintes er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Agintes kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Agintes kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Agintes igen.",
  ...
  "toast.update.description": "En ny version af Agintes ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Agintes-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (agintes.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Agintes understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Agintes inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Agintes-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Agintes",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Agintes ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Agintes følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Agintes er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Agintes starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Agintes.",
