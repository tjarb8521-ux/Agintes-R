export const dict = {
  ...
  "dialog.provider.agintes.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.agintes.tagline": "Modelos optimizados y fiables",
  "dialog.provider.agintesGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Agintes",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Agintes.",
  ...
  "provider.connect.agintesZen.line1":
    "Agintes Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.agintesZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.agintesZen.visit.prefix": "Visita ",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Agintes.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Agintes.",
  ...
  "dialog.plugins.empty": "Plugins configurados en agintes.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Agintes se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Agintes...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Agintes en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Agintes...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Agintes en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Agintes en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Agintes",
  "wsl.onboarding.agintesReadyIn": "Agintes está listo en {{distro}}.",
  "wsl.onboarding.agintesReady": "Agintes está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Agintes en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Agintes",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintes no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Agintes pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Agintes no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Agintes.",
  ...
  "toast.update.description": "Una nueva versión de Agintes ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Agintes",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (agintes.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Agintes no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Agintes incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Agintes dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Agintes",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Agintes en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Agintes sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Agintes.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Agintes",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Agintes.",
