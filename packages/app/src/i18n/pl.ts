export const dict = {
  ...
  "dialog.provider.agintes.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.agintes.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.agintesGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Agintes",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Agintes.",
  ...
  "provider.connect.agintesZen.line1":
    "Agintes Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.agintesZen.visit.prefix": "Odwiedź ",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Agintes.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Agintes.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w agintes.json",
  ...
  "dialog.server.description": "Przełącz serwer Agintes, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Agintes...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Agintes w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Agintes...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Agintes w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Agintes w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Agintes",
  "wsl.onboarding.agintesReadyIn": "Agintes jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.agintesReady": "Agintes jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Agintes w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Agintes",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintes nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Agintes będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Agintes nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Agintes.",
  ...
  "toast.update.description": "Nowa wersja Agintes ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Agintes",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (agintes.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Agintes nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Agintes zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Agintes wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Agintes",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Agintes na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Agintes ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Agintes.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Agintes",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Agintes.",
