export const dict = {
  ...
  "dialog.provider.agintes.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.agintes.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.agintesGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Agintesが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Agintesで{{provider}}モデルを使用します。",
  ...
  "provider.connect.agintesZen.line1":
    "Agintes Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.agintesZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.agintesZen.visit.prefix": " ",
  "provider.connect.agintesZen.visit.link": "agintes.ai/zen",
  "provider.connect.agintesZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAgintesで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Agintesで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "agintes.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するAgintesサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Agintesを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のAgintesを確認中...",
  "wsl.onboarding.updatingOpencode": "Agintesを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のAgintesを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のAgintesを更新してください。",
  "wsl.onboarding.updateOpencode": "Agintesを更新",
  "wsl.onboarding.agintesReadyIn": "{{distro}}内のAgintesの準備ができました。",
  "wsl.onboarding.agintesReady": "Agintesの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にAgintesをインストールしてください。",
  "wsl.onboarding.installOpencode": "Agintesをインストール",
  ...
  "wsl.onboarding.distroStatus.agintesMissing": "Agintesがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AgintesでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Agintesをもう一度開いてください。",
  ...
  "toast.update.description": "Agintesの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをAgintesチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (agintes.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: AgintesはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Agintesには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でAgintesサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Agintesの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのAgintesの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Agintesがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Agintesのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Agintes の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Agintes は最新バージョンです。",
