...
class Database extends Context.Service<Database, DatabaseShape>()("@agintes/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@agintes/example/UserStore") {
