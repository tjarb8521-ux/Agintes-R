...
import { Git } from "@agintes-ai/core/git"
...
import { ProjectDirectoryTable, ProjectTable } from "@agintes-ai/core/project/sql"
import { ProjectCopy } from "@agintes-ai/core/project/copy"
import { ProjectDirectories } from "@agintes-ai/core/project/directories"
...
async function initRepo(directory: string) {
  ...
  await $`git config user.email test@agintes.test`.cwd(directory).quiet()
