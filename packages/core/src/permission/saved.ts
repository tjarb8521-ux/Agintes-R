...
import { PermissionSaved } from "@agintes-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/v2/PermissionSaved") {}
