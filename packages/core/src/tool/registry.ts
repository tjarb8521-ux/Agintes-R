...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@agintes-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/v2/ToolRegistry") {}
