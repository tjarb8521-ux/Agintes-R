...
import type { Data, Definition, Payload } from "@agintes-ai/schema/event"
...
import { Durable } from "@agintes-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@agintes-ai/schema/event").ID
export type { Data, Definition, Payload } from "@agintes-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/Event") {}
