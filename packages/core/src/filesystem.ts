...
import { Entry, FileSystem, FindInput, Match } from "@agintes-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@agintes-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/v2/FileSystem") {}
