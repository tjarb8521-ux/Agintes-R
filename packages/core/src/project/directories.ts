...
import type { EffectDrizzleSqlite } from "@agintes-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/ProjectDirectories") {}
