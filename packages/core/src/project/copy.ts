...
import { Event } from "@agintes-ai/schema/project-directories"
import { ProjectCopy } from "@agintes-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/ProjectCopy") {}
