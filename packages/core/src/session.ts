...
import { ListAnchor } from "@agintes-ai/schema/session"
...
import { SessionDurable } from "@agintes-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/v2/Session") {}
