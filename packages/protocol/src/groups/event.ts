...
import type { Definition } from "@agintes-ai/schema/event"
...
export const AgintesEvent = event.schema
export type AgintesEvent = typeof AgintesEvent.Type
export type AgintesEventEncoded = typeof AgintesEvent.Encoded
