...
export const TypeId: TypeId = "~@agintes-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@agintes-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@agintes-ai/effect-sqlite-node/NodeSqliteClient")
