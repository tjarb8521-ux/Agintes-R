...
import { compile, emitEffectImported, emitPromise, write } from "@agintes-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "AgintesEventEncoded",
              import: 'import type { AgintesEventEncoded } from "@agintes-ai/protocol/groups/event"',
            },
          },
        }),
