...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@agintes-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.agintes || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@agintes/ToolRegistry") {}
