...
import { buildPrompt } from "@agintes-ai/core/session/compaction"
import { SessionCompactionEvent } from "@agintes-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/SessionCompaction") {}
