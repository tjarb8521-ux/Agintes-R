...
import { llmClient } from "@agintes-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@agintes-ai/llm"
import { LLMClient } from "@agintes-ai/llm/route"
import type { LLMClientService } from "@agintes-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via agintes's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @agintes-ai/llm. It
