...
import { MAX_STEPS_PROMPT } from "@agintes-ai/core/session/runner/max-steps"
...
import { LLMEvent } from "@agintes-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/SessionPrompt") {}
