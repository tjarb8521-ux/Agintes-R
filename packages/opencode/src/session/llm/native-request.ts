import type { JsonSchema, LLMRequest, ProviderMetadata } from "@agintes-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@agintes-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @agintes-ai/llm request objects from agintes's session/AI SDK-shaped data.
  return LLM.request({
