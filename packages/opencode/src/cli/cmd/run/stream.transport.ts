...
import type { Event, GlobalEvent, OpencodeClient } from "@agintes-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@agintes/RunStreamTransport") {}
