...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "agintes-gitlab-auth"
import { PoeAuthPlugin } from "agintes-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/Plugin") {}
