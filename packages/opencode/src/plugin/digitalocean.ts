import type { Hooks, PluginInput } from "@agintes-ai/plugin"
import type { Model } from "@agintes-ai/sdk/v2"
import { InstallationVersion } from "@agintes-ai/core/installation/version"
import { OauthCallbackPage } from "@agintes-ai/core/oauth/page"
...
async function listRouters(
  ...
  const res = await fetch(`${DO_GENAI_API}/models/routers`, {
    headers: {
      ...
      "User-Agent": `agintes/${InstallationVersion}`,
    },
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Agintes will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
