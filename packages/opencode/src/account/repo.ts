...
import { AccountStateTable, AccountTable } from "@agintes-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@agintes/AccountRepo") {}
