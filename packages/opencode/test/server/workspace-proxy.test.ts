...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips agintes-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-agintes-directory"]).toBeUndefined()
      expect(forwarded["x-agintes-workspace"]).toBeUndefined()
