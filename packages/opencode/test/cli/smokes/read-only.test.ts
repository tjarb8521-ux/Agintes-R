...
describe("agintes read-only commands (smoke)", () => {
  ...
  cliIt.live(
    ...
    ({ agintes }) =>
      Effect.gen(function* () {
        const r = yield* agintes.spawn(["mcp", "list"])
        agintes.expectExit(r, 0, "mcp list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ agintes }) =>
      Effect.gen(function* () {
        const r = yield* agintes.spawn(["providers", "list"])
        agintes.expectExit(r, 0, "providers list")
  ...
  cliIt.live(
    ...
    ({ agintes }) =>
      Effect.gen(function* () {
        const r = yield* agintes.spawn(["models"])
        agintes.expectExit(r, 0, "models")
  ...
  cliIt.live(
    ...
    ({ agintes }) =>
      Effect.gen(function* () {
        const r = yield* agintes.spawn(["agent", "list"])
        agintes.expectExit(r, 0, "agent list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ agintes }) =>
      Effect.gen(function* () {
        const r = yield* agintes.spawn(["session", "list"])
        agintes.expectExit(r, 0, "session list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ agintes }) =>
      Effect.gen(function* () {
        const r = yield* agintes.spawn(["stats"])
        agintes.expectExit(r, 0, "stats")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ agintes }) =>
      Effect.gen(function* () {
        const r = yield* agintes.spawn(["db", "path"])
        agintes.expectExit(r, 0, "db path")
