...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/agintes.git")).toEqual({ owner: "sst", repo: "agintes" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/agintes")).toEqual({ owner: "sst", repo: "agintes" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/agintes.git")).toEqual({ owner: "sst", repo: "agintes" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/agintes")).toEqual({ owner: "sst", repo: "agintes" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/agintes.git")).toEqual({ owner: "sst", repo: "agintes" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/agintes")).toEqual({ owner: "sst", repo: "agintes" })
})
