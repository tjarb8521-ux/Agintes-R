export const dict = {
  "app.title": "Rankingi użycia modeli AI | Agintes Data",
  "app.description":
    "Przeglądaj użycie Agintes Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Agintes Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Agintes na GitHub",
  "header.github": "GitHub",
  "header.tryAgintes": "Wypróbuj Agintes",
  ...
  "footer.homeAria": "Strona główna Agintes",
  ...
  "home.topModelsDescription": "Użycie modeli w Agintes Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Agintes Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Agintes Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Agintes Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Agintes.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Agintes",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Agintes",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Agintes z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Agintes Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Agintes Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Agintes Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Agintes Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Agintes Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Agintes Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Agintes Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Agintes Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Agintes Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Agintes Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Agintes Go.",
  ...
  "model.geoDescription": "Tokeny modelu Agintes Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Agintes Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Agintes Go.",
