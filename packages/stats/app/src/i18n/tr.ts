export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Agintes Data",
  "app.description":
    "Agintes Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Agintes Data logosu",
  ...
  "header.githubAria": "GitHub'da Agintes'a yıldız ver",
  "header.github": "GitHub",
  "header.tryAgintes": "Agintes'u dene",
  ...
  "footer.homeAria": "Agintes ana sayfası",
  ...
  "home.topModelsDescription": "Agintes Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Agintes Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Agintes Data",
  "lab.description":
    "Agintes Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Agintes kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Agintes'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Agintes kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Agintes token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Agintes Data",
  "model.description":
    "{{model}} için Agintes Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Agintes Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Agintes Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Agintes Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Agintes Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Agintes Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Agintes Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Agintes Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Agintes Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Agintes Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Agintes Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Agintes Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Agintes Go token hacmine göre yakındaki modeller.",
