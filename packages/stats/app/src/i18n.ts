...
const en = {
  "app.title": "AI Model Usage Rankings | Agintes Data",
  "app.description":
    "Explore Agintes Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Agintes Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Agintes on GitHub",
  "header.github": "GitHub",
  "header.tryAgintes": "Try Agintes",
  ...
  "home.topModelsDescription": "Usage of models across Agintes Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Agintes Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Agintes Data",
  "lab.description":
    "Compare {{lab}} models used in Agintes Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Agintes usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Agintes",
  ...
  "lab.shareOfUsage": "{{share}} of recent Agintes usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Agintes Data",
  "model.description":
    "View {{model}} Agintes Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Agintes Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Agintes Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Agintes Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Agintes Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Agintes Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Agintes Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Agintes Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Agintes Go token volume.",
