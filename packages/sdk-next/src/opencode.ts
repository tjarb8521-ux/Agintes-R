import { Agintes } from "@agintes-ai/client/effect"
...
import { createEmbeddedRoutes } from "@agintes-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Agintes.create")(function* () {
  ...
  const client = yield* Agintes.make({ baseUrl: "http://agintes.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@agintes-ai/sdk-next/Agintes") {}
