      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://agintes.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>agintes.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g agintes-ai")}>
                <code>
                  npm i -g <strong>agintes-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g agintes-ai")}>
                <code>
                  bun add -g <strong>agintes-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/agintes")}>
                <code>
                  brew install <strong>anomalyco/tap/agintes</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S agintes")}>
                <code>
                  paru -S <strong>agintes</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask agintes-desktop")}>
                <code>
                  brew install --cask <strong>agintes-desktop</strong>
                </code>
                <CopyStatus />
              </button>
