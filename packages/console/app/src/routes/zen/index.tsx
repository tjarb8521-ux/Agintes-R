...
import compareVideo from "../../asset/lander/agintes-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/agintes-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="agintes:auth" content={loggedin() ? "true" : "false"} />
