...
import { Database, eq, and, isNull } from "@agintes-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@agintes-ai/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#agintes-go")} target="_blank" rel="noopener noreferrer">
